...
class VDBSCAN():
    ...
    def fit(self, X,
        ...
        if verbose:
            ...
            '-------------------------------------------------------'
            print
            ' Feature Matrix -> ' + str(X.shape[0]) + 'x' + str(X.shape[1])
            print
            '-------------------------------------------------------'
            print
            ...
            '-------------------------------------------------------'
            print
            'Hierarchical iterations in progress...'
        self.eta = eta
        ...
        while not (finished):
            ...
            if verbose > 1:
                print
                'Current level: ' + str(current_level) + '/' + str(self.max_level) + \
                ' - eps = ' + str(self.eps) + ' '
            elif verbose > 2:
                print
                print
                ...
                if non_changes == 0:
                    if current_level > 1:
                        print
                        'Structure was altered in the last level!'
                elif non_changes == 1:
                    print
                    'Structured unchanged in the last level.'
                else:
                    print
                    'Structure unchanged in the last ' + str(non_changes) + ' levels.'
                print

            for i in range(self.n_clusters):
                if verbose > 2:
                    print
                    'Clusters analysed: ' + str(i) + '/' + \
                    str(self.n_clusters) + ' - ' + \
            ...
            if verbose > 2:
                print
                'Clusters analysed: ' + str(i + 1) + '/' + str(self.n_clusters) + ' - 100%'
            ...
            if np.array_equal(self.y, y_new):
                ...
                if verbose > 1:
                    print
                    'Unchanged levels: ' + str(non_changes)
            ...
            if verbose:
                ...
                if verbose > 2:
                    ...
                    print
                    'Noise samples after level: ' + str(n_noise) + \
        ...
        if verbose > 1:
            ...
            '\n############################################################'
            print
            '          Evolution of number of clusters:'
            print
            '############################################################\n'
